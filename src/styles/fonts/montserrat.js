...
const fontMontserrat = `
    @font-face {
        ...
        font-weight: 200;
        src: local(''),
            url('../../fonts/montserrat-v21-latin-200.woff2') format('woff2'),
            url('../../fonts/montserrat-v21-latin-200.woff') format('woff');
    }
    ...
    @font-face {
        ...
        font-weight: 300;
        src: local(''),
            url('../../fonts/montserrat-v21-latin-300.woff2') format('woff2'),
            url('../../fonts/montserrat-v21-latin-300.woff') format('woff');
    }
    ...
    @font-face {
        ...
        font-weight: 400;
        src: local(''),
            url('../../fonts/montserrat-v18-latin-regular.woff2')
                format('woff2'),
